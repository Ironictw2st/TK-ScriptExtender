...
personality object; 0.15 registry self-check; **0.16 menu build number + cfg file (wrote into the wrong object); **0.17 correct GameCore pointer (current)****.

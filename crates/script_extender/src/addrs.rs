...
const ENTRIES: &[(&str, usize, [u8; 8])] = &[
    ...
    // 0.41 diplomacy validation trace: the condition tree under dip_component_eval. FUN_1413c86b0 =
    // one campaign_diplomacy_groups node (recursive), FUN_1413d0cc0 = one requirement leaf
    ("dip_group_eval", 0x13c86b0, [0x48, 0x89, 0x5c, 0x24, 0x18, 0x48, 0x89, 0x54]),
    ("dip_requirement_eval", 0x13d0cc0, [0x48, 0x89, 0x5c, 0x24, 0x18, 0x48, 0x89, 0x54]),
    // the deal builder above them: FUN_141ad4c00 = add one component to a negotiation,
    // FUN_141ad0870 = expand the required treaties of what was added (recursive)
    ("dip_deal_add", 0x1ad4c00, [0x48, 0x89, 0x6c, 0x24, 0x10, 0x48, 0x89, 0x74]),
    ("dip_deal_expand", 0x1ad0870, [0x48, 0x89, 0x5c, 0x24, 0x10, 0x4c, 0x89, 0x4c]),
    // FUN_141ac3440 = negotiation state machine (deal, action, swap sides), FUN_141a94940 = apply a deal
    ("dip_deal_action", 0x1ac3440, [0x40, 0x53, 0x55, 0x56, 0x57, 0x41, 0x57, 0x48]),
    ("dip_deal_apply", 0x1a94940, [0x48, 0x89, 0x54, 0x24, 0x10, 0x48, 0x89, 0x4c]),
    // FUN_141b40890 = negotiation command handler, FUN_141b3ef10 = its object lookup (type 0xa0 = deal),
    // FUN_141b89ce0 = deal notification (action 0xe = waiting for the player)
    ("dip_command", 0x1b40890, [0x40, 0x55, 0x56, 0x41, 0x55, 0x48, 0x8b, 0xec]),
    ("dip_command_deal", 0x1b3ef10, [0x41, 0x56, 0x48, 0x83, 0x79, 0x30, 0x00, 0x45]),
    ("dip_notify", 0x1b89ce0, [0x48, 0x89, 0x54, 0x24, 0x10, 0x48, 0x89, 0x4c]),
    // diplomacy popup UI (dipui.rs): CcoDiplomacyNegotiation ProposeDeal / CanPropose and what they ask
    ("dipui_propose_deal", 0x2f8bf40, [0x48, 0x89, 0x5c, 0x24, 0x08, 0x57, 0x48, 0x81]),
    ("dipui_can_propose", 0x2f48cd0, [0x48, 0x89, 0x5c, 0x24, 0x18, 0x55, 0x57, 0x41]),
    ("dipui_is_counter", 0x2f70e60, [0x41, 0x56, 0x48, 0x81, 0xec, 0xc0, 0x00, 0x00]),
    ("dipui_has_forced", 0x1ac79f0, [0x48, 0x89, 0x5c, 0x24, 0x08, 0x57, 0x48, 0x83]),
    ("dipui_fabe80", 0x2fabe80, [0x41, 0x55, 0x48, 0x81, 0xec, 0x80, 0x00, 0x00]),
    ("dipui_predicate", 0x2db89b0, [0x48, 0x89, 0x5c, 0x24, 0x08, 0x48, 0x89, 0x7c]),
    ("dipui_deal_valid", 0x1ac54c0, [0x48, 0x89, 0x5c, 0x24, 0x08, 0x57, 0x48, 0x83]),
    ("dipui_is_proposer", 0x2f6ba90, [0x48, 0x89, 0x5c, 0x24, 0x08, 0x48, 0x89, 0x74]),
    ("dipui_f710c0", 0x2f710c0, [0x48, 0x89, 0x5c, 0x24, 0x08, 0x55, 0x56, 0x57]),
    ("dipui_confirm", 0x2f11010, [0x48, 0x89, 0x5c, 0x24, 0x08, 0x57, 0xb8, 0x50]),
    // FUN_142fa8000(campaign_ui, x) = per-frame campaign UI update on the main thread (followup.rs)
    // only called (followup.rs): FUN_142f71b40(negotiation wrapper) -> deal, FUN_141b3f3b0(buf, deal, op)
    // = build a negotiation command
    ("dip_negotiation_deal", 0x2f71b40, [0x48, 0x83, 0xec, 0x08, 0x44, 0x8b, 0x41, 0x10]),
    ("dip_command_build", 0x1b3f3b0, [0x48, 0x8d, 0x05, 0x69, 0x6b, 0x97, 0x01, 0x48]),
    ("campaign_ui_update", 0x2fa8000, [0x48, 0x8b, 0xc4, 0x48, 0x89, 0x50, 0x10, 0x55]),
    ("dipui_send", 0x2f256e0, [0x48, 0x89, 0x5c, 0x24, 0x10, 0x57, 0x48, 0x83]),
    ("unit_qualities_table", 0x8cad20, [0x40, 0x56, 0x57, 0x48, 0x81, 0xec, 0x08, 0x01]),

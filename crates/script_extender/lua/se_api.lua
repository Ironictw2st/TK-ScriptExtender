...
--   what horde building bundles use). With horde_income=1 in script_extender.cfg the DLL adds
--   this total to the faction's region income 1:1, so factions without regions earn from them.
